...
<template>
  <main class="h-full">
    <div class="ms-5 flex w-[30%] items-end align-middle">
      <input type="text" placeholder="GitHub username" class="relative mb-2 mr-2 rounded border border-solid border-secondary-500 bg-transparent bg-clip-padding px-3 py-1.5 text-base font-normal transition duration-300 ease-in-out text-black bg-white">
      <button type="button"
